...
These conditions are formulated rigorously in [5]. An embedding satisfying both of these properties does in fact exist. Gallagher, Jones and Rubin-Delanchy proved that the 'unfolded adjacency spectral embedding' (UASE) satisfies both properties in [5]. We shall try to apply a UASE to our data.
